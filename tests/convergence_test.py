...
def main():
    ...
    opt_traj, trace, _ = pyReSolver.minimiseResidual(init_traj, (2*np.pi)/period, pyReSolver.systems.lorenz, mean, method="L-BFGS-B", psi=psi, options={"maxiter": 100, "disp": True}, callback=lambda *args : None)
