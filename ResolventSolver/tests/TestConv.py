...
class TestConv(unittest.TestCase):
    ...
    def test_conv_scalar_fast(self):
        ...
        conv_cos_cos = conv_scalar_fast(cos_modes, cos_modes)
        conv_cos_sin = conv_scalar_fast(cos_modes, sin_modes)
        conv_sin_cos = conv_scalar_fast(sin_modes, cos_modes)
        conv_sin_sin = conv_scalar_fast(sin_modes, sin_modes)
        conv_rand1_rand1 = conv_scalar_fast(rand1, rand1)
        conv_rand1_rand2 = conv_scalar_fast(rand1, rand2)
        conv_rand2_rand1 = conv_scalar_fast(rand2, rand1)
        conv_rand2_rand2 = conv_scalar_fast(rand2, rand2)
        ...
        self.assertTrue(np.allclose(conv_rand1_rand1_sum, conv_rand1_rand1))
